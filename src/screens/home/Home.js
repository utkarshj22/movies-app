...
class Home extends Component {
    ...
    componentWillMount() {
        ...
        let that = this;
        xhr.open("GET", this.props.baseUrl + "movies?status=UPCOMING");
    ...
    genreSelectionHandler = event => {
        this.setState({ genres: event.target.value });
    }

    artistSelectionHandler = event => {
        this.setState({ artists: event.target.value });
    }

    releaseStartDateSelectionHandler = event => {
        this.setState({ releaseDateStart: event.target.value });
    }

    releaseEndDateSelectionHandler = event => {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className={classes.upcomingMoviesStyle}>
                    <span>Upcoming Movies</span>
                </div>

                <GridList cols={5} className={classes.upcomingMoviesGrid} >
                            ...
                            <CardContent>
                                ...
                                <FormControl className={classes.formControl}>
                                    ...
                                    <Select
                                        ...
                                        onChange={this.genreSelectionHandler}
                                    >
                                ...
                                <FormControl className={classes.formControl}>
                                    ...
                                    <Select
                                        ...
                                        onChange={this.artistSelectionHandler}
                                    >
                                ...
                                <FormControl className={classes.formControl}>
                                    <TextField
                                        ...
                                        onChange={this.releaseStartDateSelectionHandler}
                                    />
                                </FormControl>
                                ...
                                <FormControl className={classes.formControl}>
                                    <TextField
                                        ...
                                        defaultValue=""
                                        InputLabelProps={{ shrink: true }}
                                        onChange={this.releaseEndDateSelectionHandler}
                                    />
                                </FormControl>
                                <br /><br />
                                <FormControl className={classes.formControl}>
